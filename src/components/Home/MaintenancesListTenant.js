...
export default class MaintenancesListTenant extends Component {
    constructor(props) {
        super(props);
    ...
    makeRemoteRequestMaintenances = (id) => {
        const url = 'http://our-rent-api.herokuapp.com/api/maintenances/maintenancesForTenant/' + id;
                ...
                <View style={styles.containerMojeNepremicnine}>
                    <List containerStyle={{ borderTopWidth: 0, borderBottomWidth: 0 }}>
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <ListItem
                                    onPress={() => this.props.navigation.navigate('MojeNajemninePopravilaItem', item)}
                                    key={item.id}
                                    roundAvatar
